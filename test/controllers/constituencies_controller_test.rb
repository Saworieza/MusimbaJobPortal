...
class ConstituenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create constituency" do
    assert_difference('Constituency.count') do
      post constituencies_url, params: { constituency: { county_id: @constituency.county_id, name: @constituency.name } }
    end
  ...
  test "should update constituency" do
    patch constituency_url(@constituency), params: { constituency: { county_id: @constituency.county_id, name: @constituency.name } }
