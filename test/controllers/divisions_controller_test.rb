...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post divisions_url, params: { division: { district_id: @division.district_id, name: @division.name } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { district_id: @division.district_id, name: @division.name } }
