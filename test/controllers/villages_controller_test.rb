...
class VillagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create village" do
    assert_difference('Village.count') do
      post villages_url, params: { village: { name: @village.name, sublocation_id: @village.sublocation_id } }
    end
  ...
  test "should update village" do
    patch village_url(@village), params: { village: { name: @village.name, sublocation_id: @village.sublocation_id } }
